...
const wishlist: Omit<Watch, 'wins' | 'losses' | 'totalVotes' | 'score'>[] = [
  ...
  { id: 3, brand: 'Oris', model: 'Aquis Date', notes: 'Modern dive watch profile', imageUrl: 'https://www.oris.ch/en-NL/product/watch/aquis/aquis-date/01-733-7789-4135-07-8-23-04PEB', productUrl: 'https://www.oris.ch/en-NL/product/watch/aquis/aquis-date/01-733-7789-4135-07-8-23-04PEB' },
