...
const wishlist: Omit<Watch, 'wins' | 'losses' | 'totalVotes' | 'score'>[] = [
  ...
  { id: 6, brand: 'Oris', model: 'Big Crown Pointer Date', notes: 'Pointer-date heritage styling', imageUrl: 'https://www.watchesonline.com/media/catalog/product/4/0/4065_8_20_06.jpg?store=watchesonline&image-type=image&no_upsize=1', productUrl: 'https://www.oris.ch/en-NL/product/watch/big-crown/new-big-crown/01-754-7798-4065-07-8-20-06' },
  ...
  { id: 11, brand: 'Seiko', model: 'Prospex Alpinist', notes: 'New Alpinist, teal/blue dial, stainless steel bracelet, 39.5mm (SPB503J1)', imageUrl: 'https://www.seikowatches.com/be-nl/-/media/Images/Product--Image/All/Seiko/2025/09/03/21/04/SPB503J1/SPB503J1.png?mh=1200&mw=1200', productUrl: 'https://www.seikowatches.com/be-nl/products/prospex/spb503j1' },
  { id: 12, brand: 'Oris', model: 'Big Crown X Cervo Volante', notes: 'Blue gradient dial, Cervo Volante deer leather strap, 38mm (01 754 7779 4065-Set)', imageUrl: 'https://oris.rokka.io/fe_vuepal_no_crop/variables-w-1250--options-dpr-1.5/a1647e696a3cd01ecb49baed89c0da5a3027977a/01%20754%207779%204065-Set%20-%20Big%20Crown%20X%20Cervo%20Volante_HighRes_14351-v1.jpg', productUrl: 'https://www.oris.ch/en-NL/product/watch/big-crown/big-crown-pointer-date/01-754-7779-4065-Set' },
];
