...
const wishlist: Omit<Watch, 'wins' | 'losses' | 'totalVotes' | 'score'>[] = [
  ...
  { id: 11, brand: 'Seiko', model: 'Prospex Alpinist', notes: '1959 Alpinist Re-interpretation, blue dial, stainless steel bracelet, 38mm (SPB249J1)', imageUrl: 'https://www.seikowatches.com/fr-fr/-/media/Images/Product--Image/All/Seiko/2022/02/20/01/05/SPB249J1/SPB249J1.png?mh=1200&mw=1200', productUrl: 'https://www.seikowatches.com/fr-fr/products/prospex/spb249j1' },
  { id: 12, brand: 'Oris', model: 'Big Crown X Cervo Volante', notes: 'Blue gradient dial, Cervo Volante deer leather strap, 38mm (01 754 7779 4065-Set)', imageUrl: 'https://oris.rokka.io/fe_vuepal_crop/variables-w-600-h-247/4c7c3f5a6e841ce8170e6ff32585977c394f5761/01%20754%207779%204065-Set%20-%20Big%20Crown%20X%20Cervo%20Volante_HighRes_14356-v1.jpg', productUrl: 'https://www.oris.ch/en-NL/product/watch/big-crown/big-crown-pointer-date/01-754-7779-4065-Set' },
];
