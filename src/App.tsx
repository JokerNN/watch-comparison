...
const wishlist: Omit<Watch, 'wins' | 'losses' | 'totalVotes' | 'score'>[] = [
  ...
  { id: 12, brand: 'Oris', model: 'Big Crown X Cervo Volante', notes: 'Blue gradient dial, Cervo Volante deer leather strap, 38mm (01 754 7779 4065-Set)', imageUrl: 'https://www.eugenevanbaal.nl/media/catalog/product/cache/dad4b8db78f8edc2fe73bc504dd9b3c7/0/1/01-754-7779-4065-set---big-crown-x-cervo-volante_lowres_14343_1.webp', productUrl: 'https://www.oris.ch/en-NL/product/watch/big-crown/big-crown-pointer-date/01-754-7779-4065-Set' },
];
