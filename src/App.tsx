...
const wishlist: Omit<Watch, 'wins' | 'losses' | 'totalVotes' | 'score'>[] = [
  { id: 1, brand: 'Longines', model: 'HydroConquest', notes: 'Blue bezel, black dial, mesh bracelet', imageUrl: 'https://www.longines.com/uploads/watchshare/facebook_image/watches-conquest-l3-781-4-56-6.png', productUrl: 'https://www.longines.com/en-nl/watches/sport/hydroconquest' },
  { id: 2, brand: 'Longines', model: 'Conquest', notes: 'Classic sport watch', imageUrl: 'https://www.longines.com/uploads/watchshare/facebook_image/watches-conquest-l3-430-4-92-6.png', productUrl: 'https://www.longines.com/en-nl/watches/conquest' },
  { id: 3, brand: 'Oris', model: 'Aquis Date', notes: 'Modern dive watch profile', imageUrl: 'https://www.oris.ch/data/products/01-733-7730-4155-07-8-24-05PEB/images/01-733-7730-4155-07-8-24-05PEB.png', productUrl: 'https://www.oris.ch/en-NL/collection/aquis' },
  ...
  { id: 5, brand: 'Christopher Ward', model: 'C1 Bel Canto', notes: 'Chiming complication design', imageUrl: 'https://www.christopherward.com/on/demandware.static/-/Sites-cw-master-catalog/default/dw6dfb57a8/images/watches/C01-41APT2-T00B0-VB_front.jpg', productUrl: 'https://www.christopherward.com/int/watches/the-c1-bel-canto/C01-41APT2-T00B0-VB.html' },
  { id: 6, brand: 'Oris', model: 'Big Crown Pointer Date', notes: 'Pointer-date heritage styling', imageUrl: 'https://www.oris.ch/data/products/01-754-7741-4065-07-8-20-22/images/01-754-7741-4065-07-8-20-22.png', productUrl: 'https://www.oris.ch/en-NL/collection/big-crown' },
  { id: 7, brand: 'Oris', model: 'ProPilot X Calibre 400', notes: 'Contemporary pilot watch', imageUrl: 'https://www.oris.ch/data/products/01-400-7778-7155-07-7-20-01TLC/images/01-400-7778-7155-07-7-20-01TLC.png', productUrl: 'https://www.oris.ch/en-NL/collection/propilot-x' },
  { id: 8, brand: 'Omega', model: 'Seamaster Diver 300M', notes: 'Blue dial', imageUrl: 'https://www.omegawatches.com/media/catalog/product/o/m/omega-seamaster-diver-300m-co-axial-master-chronometer-42-mm-21030422003001-l.png', productUrl: 'https://www.omegawatches.com/en-nl/watches/seamaster/diver-300-m' },
  { id: 9, brand: 'Omega', model: 'Seamaster Aqua Terra', notes: 'Blue dial', imageUrl: 'https://www.omegawatches.com/media/catalog/product/o/m/omega-seamaster-aqua-terra-150m-co-axial-master-chronometer-41-mm-22010412103004-l.png', productUrl: 'https://www.omegawatches.com/en-nl/watches/seamaster/aqua-terra-150m' },
  { id: 10, brand: 'Maurice Lacroix', model: 'AIKON Automatic', notes: 'Integrated bracelet sports style', imageUrl: 'https://www.mauricelacroix.com/dw/image/v2/BCVJ_PRD/on/demandware.static/-/Sites-masterCatalog_MauriceLacroix/default/dw1f4bc26c/images/large/AI6008-SS002-430-1.png', productUrl: 'https://www.mauricelacroix.com/eu_en/watches/watches-aikon' },
];
